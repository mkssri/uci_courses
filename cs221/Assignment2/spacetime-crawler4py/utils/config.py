...
class Config(object):
    def __init__(self, config):
        ...
        self.DB = config["LOCAL PROPERTIES"]["PAGEDB"]
        self.tokenDict = config["LOCAL PROPERTIES"]["TOKENDICT"]
        self.simhash = config["LOCAL PROPERTIES"]["SIMHASH"]
        self.simhashLength = config["LOCAL PROPERTIES"]["SIMHASHLENGTH"]
        self.results = config["LOCAL PROPERTIES"]["RESULTS"]
        self.domains = config["LOCAL PROPERTIES"]["DOMAINS"]
