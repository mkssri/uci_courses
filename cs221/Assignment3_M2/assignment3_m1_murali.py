...
def main():
    ...
    # print("inverted_idx - {}".format(inverted_idx))
    print("len(inverted_idx) - {}".format(len(inverted_idx)))
    
    # print("url_to_idx_dict - {}".format(url_to_idx_dict))
    print("len(url_to_idx_dict) is {}".format(len(url_to_idx_dict)))

    with open("Inverted_Index_File_v2", mode="w", encoding= "UTF-8") as file1:
        file1.write(json.dumps(inverted_idx, ensure_ascii= False))
